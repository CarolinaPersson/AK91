...
df<-import("./Analysis/Input/Table_VI_Data_Set.dta")

################################################################################


#### Perform regressions using data for cohort > 40
...
#### Perform instrumental variable regressions for cohort > 40
...
stargazer(col1,col2,col3,col4,col5,col6,col7,col8,out = "Analysis/output/Table_VI_cohort40Plus.txt")
