...
df<-import("./Analysis/Input/Table_IV_Data_Set.dta")

################################################################################


#### Perform regressions using data for cohort 20-29
...
#### Perform instrumental variable regressions for cohort 20-29
...
stargazer(col1,col2,col3,col4,col5,col6,col7,col8,out = "Analysis/output/Table_IV_cohort20_29.txt")
